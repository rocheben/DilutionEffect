...
function [correlation,slope]=computedilutionEffectStrengthRandomGen(nbEspRdistrib)
...
for i=1:11;
    ...
    tauTemp=tauvec(m+i:end);
    for z=1:nbEspRdistrib
        espChosen=ceil(rand()*n);
        tau(m+espChosen)=rand();
    end
